...
export default class ResourcesPendingList extends Component{
    _isMounted = false;
    constructor(props) {
        super(props);
	...
	requestResources(reset=false, state = null){
        if(this._isMounted){
            ...
            return this.props.fetchMyResources({ type: this.scope }, initialData);
        }
	}
    ...
    render() {
        ...
        return (
            <section className="container-fluid">
                <h1 className="margin__bottom--30">Recursos pendentes de aprovação</h1>
                <UndoPortal 
                ...
                <Tabs
                    ...
                    >
                    <Tab eventKey="all" title="Todos" link="/dashboard/recursos/pendentes">
                        Todos
                    </Tab>
                    <Tab eventKey="scientific" title="Científica" link="/dashboard/recursos/pendentes/cientificamente">
                        Científica
                    </Tab>
                    <Tab eventKey="linguistic" title="Linguística" link="/dashboard/recursos/pendentes/linguisticamente">
                        Linguística
                    </Tab>
                </Tabs>
