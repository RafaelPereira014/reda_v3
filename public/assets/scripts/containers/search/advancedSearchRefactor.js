...
import AdvancedSearchRefactor from '../../components/search/advancedSearchRefactor';

class AdvancedSearchRefactorContainer extends Component {
  _isMounted = false;
    constructor(props){
        super(props);
    ...
    render() {
        return (
            <AdvancedSearchRefactor {...this.props} onSubmit={this.onSubmit}/>
        );
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(AdvancedSearchRefactorContainer);