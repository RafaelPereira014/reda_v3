...
gulp.task('build', ['clean'], function () {
  gulp.start(['vendorScripts', 'javascript', 'styles'], function () {
...
gulp.task('javascript', function(){
  gulp.start(['javascript-public','javascript-admin']);
});
...
gulp.task('javascript-public', function () {
  ...
  function bundler () {
    ...
    return watcher.bundle()
      ...
      .pipe(replace('{{{{appConfigObj}}}}', process.env.NODE_ENV))
      .pipe(buffer())
      // Source maps.
...
gulp.task('javascript-admin', function () {
  ...
  var watcher = watchify(browserify({
    transform: ['babelify'],
    entries: ['./public/assets/scripts/admin/app.js'],
    debug: true,
    cache: {},
    packageCache: {},
    fullPaths: true
...
gulp.task('styles', function () {
  gulp.start(['styles-public', 'styles-admin']);
});
...
gulp.task('styles-admin', function () {
  return gulp.src('public/assets/styles/admin/main.scss')
    .pipe($.plumber(function (e) {
      notifier.notify({
        title: 'Oops! Sass errored:',
        message: e.message
...
gulp.task('html', function () {
  if(process.env.NODE_ENV=='production'){
    ...
    /*  
    ===========================
    PAY ATTENTION TO THIS BLOCK IN YOUR HTML FILE
    <!-- build:js assets/scripts/admin-bundle.js -->
